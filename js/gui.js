...
function initVisor() {
  ...
  // console.log(base, panel, speed);
  const baseActions = [ "none", "idle", "walk", "run" ];
  ...
  base.drawArea.appendChild(select);
  baseActions.forEach( function(name) {
